...
//			return new CronJob('* * * * * *',
	...
	updateTask() {
		...
		console.log(`Automatic open at: ${openTask.sendAt()}. Next timeout: ${openTask.timeout()}`)
		console.log(`Automatic close at: ${closeTask.sendAt()}. Next timeout: ${openTask.timeout()}`)
	}
