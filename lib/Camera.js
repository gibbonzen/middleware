...
module.exports = class Camera extends Device {
	...
	_getPicture() {
		this.router.get('/picture.jpg', (req, res) => {
			...
			if(doorStatus === 2 && this.options.variations !== undefined) {
				let variations = this.options.variations
				brightness = variations.brightness !== undefined ? variations.brightness : brightness
				contrast = variations.contrast !== undefined ? variations.contrast : contrast
			}
